...
<div class="eventorganiser-event-meta">
	...
	<ul class="eo-event-meta">
		...
		<?php if ( eo_get_venue() ) {
			// Modif CMA : retirer le lien vers le lieux et ajout de l'adresse
			$tax = get_taxonomy( 'event-venue' ); ?>
			<li><strong><?php echo esc_html( $tax->labels->singular_name ) ?>:</strong> <?php eo_venue_name(); ?></li>
			<?php $venue_address = eo_get_venue_address(); ?>
			<li><strong>Adresse :</strong> <?php echo $venue_address['address'] . " " . $venue_address['postcode'] . " " . $venue_address['city']; ?></li>
		<?php } ?>

		<?php // Modif CMA - retrait des catégories et des mots-clés ?>
